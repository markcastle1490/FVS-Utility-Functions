...
variant_pvcode = do.call("rbind",
                         list(data.frame(VARIANT = "BM",
                                         SEQ = seq(from = 1, to = length(bm)),
                                         PV_CODE = bm),
                              data.frame(VARIANT = "CA",
                                         SEQ = seq(from = 1, to = length(ca)),
                                         PV_CODE = ca),
                              data.frame(VARIANT = "CI",
                                         SEQ = seq(from = 1, to = length(ci)),
                                         PV_CODE = as.character(ci)),
                              data.frame(VARIANT = "CR",
                                         SEQ = seq(from = 1, to = length(cr)),
                                         PV_CODE = cr),
                              data.frame(VARIANT = "EC",
                                         SEQ = seq(from = 1, to = length(ec)),
                                         PV_CODE = ec),
                              data.frame(VARIANT = "EM",
                                         SEQ = seq(from = 1, to = length(em)),
                                         PV_CODE = as.character(em)),
                              data.frame(VARIANT = "IE",
                                         SEQ = seq(from = 1, to = length(ie)),
                                         PV_CODE = ie),
                              data.frame(VARIANT = "LS",
                                         SEQ = seq(from = 1, to = length(ls)),
                                         PV_CODE = ls),
                              data.frame(VARIANT = "NC",
                                         SEQ = seq(from = 1, to = length(nc)),
                                         PV_CODE = nc),
                              data.frame(VARIANT = "PN",
                                         SEQ = seq(from = 1, to = length(pn)),
                                         PV_CODE = pn),
                              data.frame(VARIANT = "SO",
                                         SEQ = seq(from = 1, to = length(so)),
                                         PV_CODE = so),
                              data.frame(VARIANT = "TT",
                                         SEQ = seq(from = 1, to = length(ut)),
                                         PV_CODE = ut),
                              data.frame(VARIANT = "UT",
                                         SEQ = seq(from = 1, to = length(ut)),
                                         PV_CODE = ut),
                              data.frame(VARIANT = "WC",
                                         SEQ = seq(from = 1, to = length(wc)),
                                         PV_CODE = wc),
                              data.frame(VARIANT = "WS",
                                         SEQ = seq(from = 1, to = length(ws)),
                                         PV_CODE = ws)))
...
for(i in 1:length(pvref_files))
{
  ...
  pv_df = data.frame(VARIANT = rep(x = var, times = length(habpvr)),
                     ...
                     SEQ = seq(from = 1, to = length(habpvr)),
                     HABPVR = habpvr,
                     PVCODE = pvcode, 
                     PVREF = pvref)
