...
fvs_sum = tree |>
  ...
  summarize(BA_ = ba(dbh = DBH, expf = TPA),
            ...
            TCUFTG50 = expand_attr(dbh = DBH, attr = TCuFt, expf = TPA, htmin = 50, ht = Ht),
            ...
            TCUFTL50 = expand_attr(dbh = DBH, attr = TCuFt, expf = TPA, htmax = 50, ht = Ht),
            CCL50 = cc(dbh = DBH, crwidth = CrWidth, expf = TPA, htmax = 50, ht = Ht),
            ...
            RDIA_ = gmd(dbh = DBH, expf = TPA, species = SpeciesFVS)) |>
  arrange(CaseID, Year)
...
size_test = tree |>
  ...
  summarize(QMD1 = qmd(dbh = DBH, expf = TPA),
            ...
            AVGD1 = mean_attr(attr = DBH, dbh = DBH, weight = TPA),
            ...
            TOPHT1 = mean_attr(attr = Ht, dbh = DBH, weight = TPA),
...
fvs_sum_f = tree |>
  ...
  summarize(BA_ = ba_f(dbh = DBH, expf = TPA),
            ...
            TCUFTG50 = expand_attr_f(dbh = DBH, attr = TCuFt, expf = TPA, htmin = 50, ht = Ht),
            ...
            TCUFTL50 = expand_attr_f(dbh = DBH, attr = TCuFt, expf = TPA, htmax = 50, ht = Ht),
            CCL50 = cc_f(dbh = DBH, crwidth = CrWidth, expf = TPA, htmax = 50, ht = Ht),
            ...
            RDIA_ = gmd_f(dbh = DBH, expf = TPA, species = SpeciesFVS)) |>
  arrange(CaseID, Year)
