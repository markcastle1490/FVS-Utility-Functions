################################################################################
#' @name sp_df
#' @title Retrieve FIA Species Reference Dataframe
...
################################################################################
#' @name sp_lookup
#' @title Look Up FIA Species Taxonomy and Attribute Metadata
...
################################################################################
#' @name sp_fia_index
#' @title Retrieve Row Index by Numeric FIA Species Code
#' @description This function is used to obtain an index value (row number) from
#' the data frame that is returned from sp_df function.
#' 
#' @param spcd
